...
const buttonVariants = cva(
  "group/button relative inline-flex shrink-0 items-center justify-center rounded-full border border-transparent bg-clip-padding text-sm font-medium whitespace-nowrap transition-all outline-none select-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg]:relative [&_svg]:z-10 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        default: "gel-surface border-white/70 text-primary-foreground hover:brightness-105",
        outline:
          "chip-gel text-foreground hover:bg-white/70 aria-expanded:bg-white/80",
        secondary: "gel-lime border-white/70 hover:brightness-105",
        ghost:
          "hover:bg-white/40 hover:text-foreground aria-expanded:bg-white/50",
        destructive:
          "bg-destructive/10 text-destructive hover:bg-destructive/20 focus-visible:border-destructive/40 focus-visible:ring-destructive/20",
        link: "text-sky-deep underline-offset-4 hover:underline",
        gel: "gel-surface border-white/70 text-primary-foreground hover:brightness-105",
        frost: "chip-gel text-foreground hover:bg-white/75",
      },
      size: {
        default:
