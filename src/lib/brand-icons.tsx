...
function createBrandIcon(displayName: string, children: ReactNode): LucideIcon {
  const Icon = forwardRef<SVGSVGElement, SVGProps<SVGSVGElement>>(
    ({ color = "currentColor", width = 24, height = 24, strokeWidth = 2, ...props }, ref) => (
      <svg
        ref={ref}
...
/** Lucide-compatible outline brand marks for nav gems. */
export const LinkedinIcon = createBrandIcon("LinkedinIcon", (
  <>
